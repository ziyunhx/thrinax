...
namespace Thrinax.Chardet.NChardet
{
    ...
    public class PSMDetector
    {
        ...
        public PSMDetector()
        {
            initVerifiers(Language.ALL);
            Reset();
        }

        public PSMDetector(Language langFlag)
        {
        ...
        protected void initVerifiers(Language currVerSet)
        {
            //int idx = 0 ;
            Language currVerifierSet;

            if (currVerSet >= 0 && currVerSet < Language.NO_OF_LANGUAGES)
            {
                currVerifierSet = currVerSet;
            }
            else {
                currVerifierSet = Language.ALL;
            }

            mVerifier = null;
            mStatisticsData = null;

            if (currVerifierSet == Language.TRADITIONAL_CHINESE)
            {
            ...
            //==========================================================
            else if (currVerifierSet == Language.KOREAN)
            {
                mVerifier = new Verifier[] {
                      new UTF8Verifier(),
                      new EUCKRVerifier(),
            ...
            //==========================================================
            else if (currVerifierSet == Language.SIMPLIFIED_CHINESE)
            {
                mVerifier = new Verifier[] {
                      new UTF8Verifier(),
                      new GB2312Verifier(),
            ...
            //==========================================================
            else if (currVerifierSet == Language.JAPANESE)
            {
                mVerifier = new Verifier[] {
                      new UTF8Verifier(),
                      new SJISVerifier(),
            ...
            //==========================================================
            else if (currVerifierSet == Language.CHINESE)
            {
                mVerifier = new Verifier[] {
                      new UTF8Verifier(),
                      new GB2312Verifier(),
            ...
            //==========================================================
            else if (currVerifierSet == Language.ALL)
            {
                mVerifier = new Verifier[] {
                      new UTF8Verifier(),
                      new SJISVerifier(),
